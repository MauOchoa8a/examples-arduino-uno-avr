...
Ejemplo mínimo en C puro para hacer parpadear el LED integrado con un ritmo diferente de un Arduino Uno mediante acceso directo a los registros del ATmega328P.
